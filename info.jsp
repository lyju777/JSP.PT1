...
<body>
    ...
    <form action="info_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p id="idcheckmsg"></p>
        <p><label>비밀번호 : <input type="password" name="userpw" id="userpw" maxlength="20" value=<%=session.getAttribute("userpw") %>></label></p>
        <p><label>비밀번호 확인 : <input type="password" name="userpw_re" id="userpw_re" maxlength="20" value=<%=session.getAttribute("userpw_re") %>></label></p>
